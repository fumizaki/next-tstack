...
export const EditorTheme: EditorThemeClasses = {
    ...
    list: {
        listitem: 'ml-6 mb-1',
        listitemChecked: 'relative ml-6 mb-1 list-none line-through text-muted-foreground',
    ...
    tableCellActionButtonContainer: 'absolute right-0 top-0 flex items-center justify-center',
    tableCellEditing: 'relative p-2 border border-blue-500 outline-none',
    tableCellHeader: 'bg-gray-100 font-semibold text-left p-2 border border-gray-200',
    tableCellPrimarySelected: 'border-2 border-blue-500',
    tableCellResizer: 'absolute right-0 top-0 w-1 h-full cursor-col-resize bg-blue-500',
